...
if($arResult['ITEMS']){?>
    <section class="section-slider">
        <div class="slider-home slider-home__2"
            ...
            <?foreach ($arResult['ITEMS'] as $k => $arSlide){
                ...
                ?>
                <div class="slide-item slide-item__2<?=$arSlide['PROPERTIES']['SLIDE_SHADOW']['VALUE_XML_ID'] == 'Y' ? ' c-shadow' : ''?>"
                     style="background-image: url(<?=$arSlide['PREVIEW_PICTURE']['SRC']?>);"
                     id="<?=$this->GetEditAreaId($arSlide['ID']);?>">
                    <div>
                        <div class="row">
                            <div class="slide-item__caption slide-item__caption__2 col-12">
        ...
        <?if(count($arResult['ITEMS']) > 1){?>
            <div class="slider-dots slider-dots__2">
                <div class="container">
